...
function SearchResults() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      fetch(`/api/books?search=${encodeURIComponent(query)}`).then((r) => r.json()),
  ...
  return (
    <>
      {loading && <p style={{ color: "#9a9a9a", fontSize: "1.1rem" }}>Searching...</p>}
              ...
              <div className="card-inner">
                <div className="book-cover">
                  {book.image ? (
                    ...
                    <div className="placeholder-cover"><span>{book.title.charAt(0)}</span></div>
                  )}
  ...
  return (
    <main className="search-page">
      ...
      <style jsx global>{`
        ...
        .placeholder-cover { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; font-size: 4rem; font-weight: 700; color: #ffb000; }
        ...
        .empty-state { display: flex; flex-direction: column; align-items: center; gap: 1.5rem; padding: 6rem 2rem; text-align: center; }
