...
const navbar = () => {
  return (
    <>
     ...
     <nav className='flex border-b-[0.01rem] border-zinc-700 justify-between fixed left-0 right-0 z-999 bg-black items-center h-96px sm:h-100px md:h-120px shadow-md shadow-yellow-100'>
